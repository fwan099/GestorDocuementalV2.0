                        ...
                        <div class="col-xl-7 mb-3 mb-xl-0">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body py-0" style="height: 250px; max-height: 275px">
                                    <canvas id="_dm-networkChart" width="694" height="250" style="display: block; box-sizing: border-box; height: 250px; width: 694px;"></canvas>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-success text-white overflow-hidden mb-3">
                                        ...
                                        <div class="py-0" style="height: 70px; margin: 0 -5px -5px;">
                                            <canvas id="_dm-hddChart" width="369" height="70" style="display: block; box-sizing: border-box; height: 70px; width: 369px;"></canvas>
                                        </div>
                                        <!-- END : Area Chart -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-info text-white overflow-hidden mb-3">
                                        ...
                                        <!-- Line Chart -->
                                        <div class="py-0" style="height: 70px; margin: 0 -5px -5px;">
                                            <canvas id="_dm-earningChart" width="369" height="70" style="display: block; box-sizing: border-box; height: 70px; width: 369px;"></canvas>
                                        </div>
                                        <!-- END : Line Chart -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-purple text-white overflow-hidden mb-3">
                                        ...
                                        <div class="py-0" style="height: 70px">
                                            <canvas id="_dm-salesChart" width="359" height="70" style="display: block; box-sizing: border-box; height: 70px; width: 359px;"></canvas>
                                        </div>
                                        <!-- END : Bar Chart -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-warning text-white overflow-hidden mb-3">
                                        ...
                                        <div class="py-0 pb-2" style="height: 70px">
                                            <canvas id="_dm-taskChart" width="359" height="62" style="display: block; box-sizing: border-box; height: 62px; width: 359px;"></canvas>
                                        </div>
